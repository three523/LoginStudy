...
#define kServiceAppUrlScheme    @NAVER_APPURLSCHEME

#define kConsumerKey            @NAVER_CLIENTID
#define kConsumerSecret         @NAVER_CLIENTSECRET
#define kServiceAppName         @APPNAME
